...
export class MarketplaceComponent implements OnInit {
  ...
  async loadAdvanceFilter(){
    let data = await this.marketplaceService.advanceSearch(this.search, this.sliderTransaction, this.typeSales, this.search, this.sliderCommission, this.commissionStatus)
